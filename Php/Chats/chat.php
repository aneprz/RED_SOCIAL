...
<main>
    <?php
        // 2️⃣ Determinar nombre y foto para encabezado
        if ($chat['es_grupo']) {
            ...
            $nombreChat = "Usuario";
            $fotoPerfil = '../../../Media/foto_default.png';

            foreach ($participantes as $p) {
                if ($p['id'] != $idUsu) {
                    $nombreChat = $p['username'];
                    $fotoPerfil = !empty($p['foto_perfil'])
                        ? $p['foto_perfil']
